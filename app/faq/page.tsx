...
export default function FAQPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Our standard initial consultation fee is $150. This fee covers a comprehensive review of your case and preliminary legal advice. Fees for ongoing representation are discussed during the consultation.',
    },
    {
  ...
  return (
    <div className="bg-light text-primary min-h-screen">
      ...
      <section className="bg-primary py-24 relative overflow-hidden flex items-center justify-center">
        ...
        <div className="absolute inset-0 bg-[url('https://picsum.photos/1920/600?random=8')] opacity-10 object-cover mix-blend-overlay"></div>
